...
import MageMod.patches.relics.BottledPlaceholderField;
import MageMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static MageMod.DefaultMod.makeRelicOutlinePath;
import static MageMod.DefaultMod.makeRelicPath;
